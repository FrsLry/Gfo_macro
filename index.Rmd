...
* Multi-faceted phenomenon (species richness, turnover, abundance)
...
$$\Rightarrow \Delta^2N = \Delta R - \Delta L$$
...
$$\Rightarrow \frac{\Delta N}{N_{t0}} = \frac{R}{N_{t0}} - \frac{L}{N_{t0}}$$
...
* 3 chains per species $\times$ 564 species $\Rightarrow$ **1692 MCMC chains**
